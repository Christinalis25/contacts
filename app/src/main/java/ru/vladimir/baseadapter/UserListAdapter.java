...
public class UserListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (u.sex) {
            case M: userPic.setImageResource(R.drawable.user_man); break;
            case W: userPic.setImageResource(R.drawable.user_woman); break;
            case U: userPic.setImageResource(R.drawable.user_unknown); break;
        }
